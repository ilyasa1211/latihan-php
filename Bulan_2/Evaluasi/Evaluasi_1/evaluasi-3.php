...
for ($i = 0; $i < $berapa_banyak; $i++) {
    ...
    if ($usia < 25)
        $kurang_dari_25[] = $nama;
    if ($usia < $usia_terkecil_angka)
        $usia_terkecil_angka = $usia;
    if ($i == $berapa_banyak - 1)
        foreach ($students as $kunci => $nilai) {
        }
}
echo "\n";
echo "Yang minat sebagai Backend adalah ";
foreach ($minat_backend as $a)
    echo $a . ", ";
echo "\n";
echo "Usia yang kurang dari 25 adalah ";
foreach ($kurang_dari_25 as $a)
    echo $a . ", ";
echo "\n";
echo "Usia paling muda adalah ";
foreach ($paling_muda as $a)
    echo $a . ", ";
echo "\n";