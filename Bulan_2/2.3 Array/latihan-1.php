...
if ($banyaknya_data % 2 == 0)
    ...
    $median = $data[($banyaknya_data - 1) / 2];
...
foreach ($data as $dat) {
    ...
    foreach ($data as $da)
        if ($dat == $da)
            $jumlah_terbanyak_sementara++;
    if ($jumlah_terbanyak < $jumlah_terbanyak_sementara)
        $jumlah_terbanyak = $jumlah_terbanyak_sementara;
}
...
foreach ($data as $dat) {
    ...
    foreach ($data as $da)
        if ($dat == $da)
            $jumlah_terbanyak_sementara++;
    if ($jumlah_terbanyak == $jumlah_terbanyak_sementara) if ($data_yang_sudah_ada != $dat)
        $modus[] = $data_yang_sudah_ada = $dat;
}
echo "Modus = ";
